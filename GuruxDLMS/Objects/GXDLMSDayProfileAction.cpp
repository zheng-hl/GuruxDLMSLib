...
/** 
 Constructor.
*/
CGXDLMSDayProfileAction::CGXDLMSDayProfileAction(CGXDateTime startTime, basic_string<char> scriptLogicalName, int scriptSelector)
{
...
*/
basic_string<char> CGXDLMSDayProfileAction::GetScriptLogicalName()
{
    return m_ScriptLogicalName;
}
void CGXDLMSDayProfileAction::SetScriptLogicalName(basic_string<char> value)
{
