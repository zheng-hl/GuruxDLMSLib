...
public:	
	//Constructor.
	CGXDLMSGPRSSetup() : CGXDLMSObject(OBJECT_TYPE_GPRS_SETUP)
	{
	}

	//SN Constructor.
	CGXDLMSGPRSSetup(unsigned short sn) : CGXDLMSObject(OBJECT_TYPE_GPRS_SETUP, sn)
	{

	}

	//LN Constructor.
	CGXDLMSGPRSSetup(basic_string<char> ln) : CGXDLMSObject(OBJECT_TYPE_GPRS_SETUP, ln)
	{
