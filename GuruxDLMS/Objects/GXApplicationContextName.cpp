...
string CGXApplicationContextName::GetLogicalName()
{
	return m_LogicalName;
}

void CGXApplicationContextName::SetLogicalName(string value)
{
	m_LogicalName = value;
}
...
string CGXApplicationContextName::ToString()
{
	std::stringstream sb;
	sb.write(m_LogicalName.c_str(), m_LogicalName.size());
	sb << " ";
	sb << CGXDLMSVariant(m_JointIsoCtt).ToString().c_str();
	sb << " ";
    sb << CGXDLMSVariant(m_Country).ToString();
	sb << " ";
	...
	sb << " ";
	sb << CGXDLMSVariant(m_ApplicationContext).ToString().c_str();
	sb << " ";
	sb << CGXDLMSVariant(m_ContextId).ToString().c_str();
	return sb.str();
}
