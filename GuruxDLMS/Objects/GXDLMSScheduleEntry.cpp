...
basic_string<char> CGXDLMSScheduleEntry::GetLogicalName() {
    return m_LogicalName;
}

void CGXDLMSScheduleEntry::SetLogicalName(basic_string<char> value) {
    m_LogicalName = value;
}
...
basic_string<char> CGXDLMSScheduleEntry::GetExecWeekdays() {
    return m_ExecWeekdays;
}

void CGXDLMSScheduleEntry::SetExecWeekdays(basic_string<char> value) {
    m_ExecWeekdays = value;
}

basic_string<char> CGXDLMSScheduleEntry::GetExecSpecDays() {
    return m_ExecSpecDays;
}

void CGXDLMSScheduleEntry::SetExecSpecDays(basic_string<char> value) {
