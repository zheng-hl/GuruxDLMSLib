...
private:
    ...
    */
     ...
     */
    basic_string<char> m_ExecWeekdays;

    /**
     * Perform the link to the IC “Special days table”, day_id.
     */
    basic_string<char> m_ExecSpecDays;
...
public:
     ...
     */
    basic_string<char> GetExecWeekdays();
     ...
     */
    void SetExecWeekdays(basic_string<char> value);
     ...
     * @return day_id.
     */
    basic_string<char> GetExecSpecDays();
     ...
     *            day_id
     */
    void SetExecSpecDays(basic_string<char> value);
